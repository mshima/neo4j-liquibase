...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (ex instanceof com.mycompany.myapp.service.EmailAlreadyUsedException) return new EmailAlreadyUsedException()
            .getProblemDetailWithCause();
        if (ex instanceof com.mycompany.myapp.service.UsernameAlreadyUsedException) return new LoginAlreadyUsedException()
            .getProblemDetailWithCause();
        if (
